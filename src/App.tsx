    ...
    <div className="min-h-screen flex flex-col items-center justify-start py-12 px-4 md:px-8 bg-reactor-bg selection:bg-reactor-cyan/30 overflow-y-auto">
      ...
      <main className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-4 space-y-6 order-3">
          ...
          {/* Log Section */}
          <div className="p-4 rounded-2xl bg-black/40 border border-white/5 font-mono text-[10px] text-slate-600 flex flex-col h-64">
            <div className="flex items-center justify-between mb-2 border-b border-white/5 pb-2 sticky top-0 bg-black/40 z-10">
              <p className="text-slate-400 uppercase tracking-widest">System Log</p>
              <div className="relative">
                <input 
                  ...
                  className="bg-white/5 border border-white/10 rounded px-2 py-0.5 text-[8px] uppercase tracking-tighter focus:outline-none focus:border-reactor-cyan/50 w-24 transition-all focus:w-32"
                />
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto scrollbar-hide space-y-1">
              <AnimatePresence initial={false}>
                {filteredLogs.length > 0 ? (
                  ...
                  <p className="text-center py-8 text-slate-700 italic">No matching logs found</p>
                )}
              </AnimatePresence>
            </div>
          </div>
